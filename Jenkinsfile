    ...
    stages {
        ...
        stage('Gitleaks Scan') {
            steps {
                ...
                bat 'C:\\Users\\HP\\AppData\\Local\\Microsoft\\WinGet\\Packages\\Gitleaks.Gitleaks_Microsoft.Winget.Source_8wekyb3d8bbwe\\gitleaks detect --source C:\\repogithub\\pygoat\\ -v'
            }
        }
